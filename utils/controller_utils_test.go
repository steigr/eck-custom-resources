...
func TestCommonEventFilter(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:           "annotation last-update-triggered-at changed - should process",
			oldGeneration:  1,
			newGeneration:  1,
			oldAnnotations: map[string]string{LastUpdateTriggeredAtAnnotation: "1000"},
			newAnnotations: map[string]string{LastUpdateTriggeredAtAnnotation: "2000"},
			want:           true,
		},
		{
			name:           "annotation last-update-triggered-at added - should process",
			oldGeneration:  1,
			newGeneration:  1,
			oldAnnotations: nil,
			newAnnotations: map[string]string{LastUpdateTriggeredAtAnnotation: "1000"},
			want:           true,
		},
		{
			name:           "annotation last-update-triggered-at removed - should process",
			oldGeneration:  1,
			newGeneration:  1,
			oldAnnotations: map[string]string{LastUpdateTriggeredAtAnnotation: "1000"},
			newAnnotations: nil,
		...
		{
			name:           "annotation last-update-triggered-at unchanged - should skip",
			oldGeneration:  1,
			newGeneration:  1,
			oldAnnotations: map[string]string{LastUpdateTriggeredAtAnnotation: "1000"},
			newAnnotations: map[string]string{LastUpdateTriggeredAtAnnotation: "1000"},
		...
		{
			name:           "other annotation changed - should skip",
			oldGeneration:  1,
			newGeneration:  1,
			oldAnnotations: map[string]string{"other-annotation": "value1"},
			newAnnotations: map[string]string{"other-annotation": "value2"},
			want:           false,
		},
	}
